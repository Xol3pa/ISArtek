    ...
    public partial class StockIn : Form
    {
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    i++;
                    dgvInStockHistory.Rows.Add(i, dr[0].ToString(), dr[1].ToString(), dr[2].ToString(), dr[3].ToString(), dr[4].ToString(), DateTime.Parse(dr[5].ToString()).ToString("yyyy-MM-dd"), dr[6].ToString(), dr["supplier"].ToString());
